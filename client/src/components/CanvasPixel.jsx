...
const CanvasPixel = ({ pixelColor, score }) => {
  ...
  const styleChar = {
    width: '2em',
    height: '2em',
    backgroundColor: score < 20 ? 'rgba(230, 230, 255, 0)' : score >= 20 && score < 40 ? 'rgba(255, 255, 179, 0)' : score >= 40 && score < 60 ? 'rgba(179, 230, 255,0)' : score >= 60 && score < 80 ? 'rgba(204, 255, 204, 0)' : 'rgba(255, 230, 230, 0)',
